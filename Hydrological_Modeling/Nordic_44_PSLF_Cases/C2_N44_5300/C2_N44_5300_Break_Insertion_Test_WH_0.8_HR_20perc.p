...
@return = getf("N44_Statnett_GE_origi_BI_Load_b5300_L_500_MW_C8.sav")   /*loading the sav case after making hydro units update in the powerflow*/
solpar[0].tapadj = 0 
solpar[0].swsadj = 0 
solpar[0].psadj  = 0
solpar[0].dccadj = 0
...
$Data = "N44_Hydro_Gens_Latest_Water_Head_DynFile_Input_WH_0p8_HR_20perc.csv"  /*comment the above line and need to use this line for the base case scenario where head value for all the hydro units is 1 pu*/
@ret=setinput($Data)
...
$channels_INIT_errors = "N44_WH_HR_var_C8_5300.chf"

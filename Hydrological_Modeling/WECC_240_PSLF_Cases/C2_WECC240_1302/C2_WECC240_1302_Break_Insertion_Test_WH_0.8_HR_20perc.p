...
@return = getf("WECC240_newOC_C2.sav")   /*loading the sav case after making hydro units update in the powerflow*/
solpar[0].tapadj = 0 
solpar[0].swsadj = 0 
solpar[0].psadj  = 0
solpar[0].dccadj = 0
...
$Data = "MiniWECC240_Hydro_Gens_Latest_Water_Head_DynFile_Input_WH_0p8_HR_20perc_corr.csv"  /*comment the above line and need to use this line for the base case scenario where head value for all the hydro units is 1 pu*/
@ret=setinput($Data)
...
for @i=0 to @num_hydro_gens-1
	...
	logterm(#Voltage_level[@i]," is the voltage levels <")
	logterm(*Unit_ID[@i]," is the unit ID <")
	logterm(#WH[@i]," is the water level <")
next
...
$channels_INIT_errors = "WECC240_WH_HR_var_C2_L_1302.chf"

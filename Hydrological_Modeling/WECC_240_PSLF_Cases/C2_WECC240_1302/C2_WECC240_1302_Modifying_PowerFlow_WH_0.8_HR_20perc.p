...
@ret = change_dir("D:\AV\MiniWECC240_PSLFv22_SD\Case2_WECC240_WH_0p8_HR_0p2_BI_1302")
...
$original_sav = "240bus_MiniWECC_PSLF_sav_L_1302_1000MW" 
...
$Data = "MiniWECC240_Hydro_Gens_Capped_NewOC_PF_Input_WH_0p8_HR_20perc_corr.csv" 
@ret=setinput($Data)
logterm(@ret,"<")
...
@return = savf("WECC240_newOC_C2.sav")


$Total_Pgen_Changed =                   "WECC240_Total_PGen_Changed.txt"
$Total_Net_Pgen_Changed =           "WECC240_Total_Net_PGen_Changed.txt"
$Total_Hydro_Gens_Changed = "WECC240_Total_Hydro_Generators_Updated.txt"

@return = setlog("WECC240_Total_PGen_Changed.txt")
logprint("WECC240_Total_PGen_Changed.txt",@pgen_change,"<")	
@return = close("WECC240_Total_PGen_Changed.txt")

@return = setlog("WECC240_Total_Net_PGen_Changed.txt")
logprint("WECC240_Total_Net_PGen_Changed.txt",@net_pgen_change,"<")
@return = close("WECC240_Total_Net_PGen_Changed.txt")
	
@return = setlog("WECC240_Total_Net_PGen_Changed.txt")
logprint("WECC240_Total_Net_PGen_Changed.txt",@counter,"<")
@return = close("WECC240_Total_Net_PGen_Changed.txt")	

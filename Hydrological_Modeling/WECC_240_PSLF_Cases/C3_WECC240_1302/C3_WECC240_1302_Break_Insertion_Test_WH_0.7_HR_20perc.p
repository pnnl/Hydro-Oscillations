...
@return = getf("WECC240_newOC_C3.sav")   /*loading the sav case after making hydro units update in the powerflow*/
solpar[0].tapadj = 0 
solpar[0].swsadj = 0 
solpar[0].psadj  = 0
solpar[0].dccadj = 0
...
$Data = "MiniWECC240_Hydro_Gens_Latest_Water_Head_DynFile_Input_WH_0p7_HR_20perc.csv"  /*comment the above line and need to use this line for the base case scenario where head value for all the hydro units is 1 pu*/
@ret=setinput($Data)
...
$channels_INIT_errors = "WECC240_WH_HR_var_C3_L_1302.chf"

...
$original_sav = "N44_Statnett_GE_origi_BI_Load_b5300_L_500_MW" 
...
$Data = "N44_Hydro_Gens_Capped_NewOC_PF_Input_WH_0p7_HR_20perc.csv" 
@ret=setinput($Data)
logterm(@ret,"<")
...
logterm(#Bus_number[49],"<")
logterm(*Bus_names[49],"<")
logterm(*Unit_ID[49],"<")
logterm(*Hydro_flag[49],"<")
logterm(#Voltage_level[49],"<")
logterm(*Status[49],"<")
logterm(*BL[49],"<")
...
$Total_Pgen_Changed =                   "N44_Total_PGen_Changed.txt"
$Total_Net_Pgen_Changed =           "N44_Total_Net_PGen_Changed.txt"
$Total_Hydro_Gens_Changed = "N44_Total_Hydro_Generators_Updated.txt"

@return = setlog("N44_Total_PGen_Changed.txt")
logprint("N44_Total_PGen_Changed.txt",@pgen_change,"<")	
@return = close("N44_Total_PGen_Changed.txt")

@return = setlog("N44_Total_Net_PGen_Changed.txt")
logprint("N44_Total_Net_PGen_Changed.txt",@net_pgen_change,"<")
@return = close("N44_Total_Net_PGen_Changed.txt")
	
@return = setlog("N44_Total_Net_PGen_Changed.txt")
logprint("N44_Total_Net_PGen_Changed.txt",@counter,"<")
@return = close("N44_Total_Net_PGen_Changed.txt")	
